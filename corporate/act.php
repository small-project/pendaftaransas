...
if(isset($_POST['ajukanBPO'])){
    ...
    //         $sql = "INSERT INTO tb_temporary_perusahaan (no_pendaftaran, kd_perusahaan, nama_perusahaan, cp, phone, email, kebutuhan, kode_pekerjaan, nama_project, status) VALUES (:kode, :kd, :nama, :cp, :telp, :email, :kebutuhan, :pekerjaan, :nama_project, :st)";
    //     $stmt = $data->runQuery($sql);
    //     $stmt->execute(array(
    //         ':kode' =>$nomor,
    //         ':kd'   =>$kd_perusahaan,
