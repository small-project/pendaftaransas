...
<div class="container">
        ...
        <form method="post" class="form-signin">
            ...
            <input type="text" class="form-control" name="txt_uname" placeholder="enter Kartu Tanda Penduduk" value="<?php if(isset($error)){echo $uname;}?>" />
            </div>
            <div class="form-group">
            <input type="email" class="form-control" name="txt_umail" placeholder="enter email id" value="<?php if(isset($error)){echo $umail;}?>" />
            </div>
            <div class="form-group">
